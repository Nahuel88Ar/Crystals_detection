...
if st.button("Start script 1") and bf_files and pl_files:
    ...
    if len(bf_files) != len(pl_files):
        ...
        for bf_file, pl_file in zip(bf_files, pl_files):
            ...
            #with open(histogram_path, "rb") as g:
            #    st.download_button("Download Histogram of pixels intensity", g, file_name=os.path.basename(histogram_path))
            ...
            st.pyplot(annotated_image)  # Display the plot in Streamlit
