...
# File Uploads
bf_files = st.file_uploader("Upload Brightfield Images", accept_multiple_files=True, type=["png", "jpg", "jpeg", "tif"])
pl_files = st.file_uploader("Upload PL Images", accept_multiple_files=True, type=["png", "jpg", "jpeg", "tif"])
